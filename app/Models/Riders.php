...
class Riders extends Model
{
    ...
    public static array $rules = [
        ...
        'doj' => 'nullable',
        'emirate_hub' => 'nullable|string|max:191',
        ...
        'visa_occupation' => 'nullable|string|max:100',
        'status' => 'nullable|boolean',
        'TAID' => 'nullable',
        'fleet_supervisor' => 'nullable|string|max:50',
        'passport_handover' => 'nullable|string|max:50',
        ...
        'salary_model' => 'nullable|string|max:100',
        'rider_reference' => 'nullable|string|max:255',
