          ...
          },
          {
            ...
            value: function _setup() {
              ...
              var createOptionElement = function createOptionElement(nameVal, title, inputName, isDarkStyle, image) {
                image = image || nameVal;
                return _this2._getElementFromString(
                  '<div class="col-4 px-2">\n      <div class="form-check custom-option custom-option-icon mb-0">\n        <label class="form-check-label custom-option-content p-0" for="'
                    ...
                    .concat(image)
                    .concat(isDarkStyle ? '-dark' : '', '.svg" alt="')
                    .concat(
                      title,
              ...
              if (!this._hasControls('style')) {
                ...
                this.settings.availableStyles.forEach(function (style) {
                  var styleEl = createOptionElement(
                    style.name,
                    style.title,
                    'customRadioIcon',
                ...
                styleOpt
                  .querySelector('input[value="'.concat(this.settings.stylesOpt, '"]'))
              ...
              if (!this._hasControls('themes')) {
                ...
                this.settings.availableThemes.forEach(function (theme) {
                  ...
                  var themeEl = createOptionElement(
                    theme.name,
                    theme.title,
                    'themeRadios',
                    cl.contains('dark-style'),
              ...
              if (!this._hasControls('rtl headerType contentLayout layoutCollapsed layoutNavbarOptions', true)) {
                ...
                if (!this._hasControls('rtl') || !rtlSupport) {
                  ...
                  directionOpt
                    .querySelector('input[value="'.concat(this.settings.rtl ? 'rtl' : 'ltr', '"]'))
                    .setAttribute('checked', 'checked');
                ...
                if (!this._hasControls('headerType')) {
                  ...
                  this.settings.availableHeaderTypes.forEach(function (header) {
                    var headerEl = createOptionElement(
                      header.name,
                      header.title,
                      'headerRadioIcon',
                      cl.contains('dark-style'),
                      'horizontal-'.concat(header.name)
                    );
                    headerOpt.appendChild(headerEl);
                  });
                  headerOpt
                    .querySelector('input[value="'.concat(this.settings.headerType, '"]'))
                    .setAttribute('checked', 'checked');
                ...
                if (!this._hasControls('contentLayout')) {
                  ...
                  this.settings.availableContentLayouts.forEach(function (content) {
                    var contentEl = createOptionElement(
                      content.name,
                      content.title,
                      'contentRadioIcon',
                      cl.contains('dark-style')
                  ...
                  contentOpt
                    .querySelector('input[value="'.concat(this.settings.contentLayout, '"]'))
                    .setAttribute('checked', 'checked');
                ...
                if (!this._hasControls('layoutCollapsed')) {
                  ...
                  this.settings.availableLayouts.forEach(function (layoutOpt) {
                    var layoutsEl = createOptionElement(
                      layoutOpt.name,
                      layoutOpt.title,
                      'layoutsRadios',
                      cl.contains('dark-style')
                  ...
                  layoutCollapsedOpt
                    .querySelector(
                      'input[value="'.concat(this.settings.layoutCollapsed ? 'collapsed' : 'expanded', '"]')
                    )
                    .setAttribute('checked', 'checked');
                ...
                if (!this._hasControls('layoutNavbarOptions')) {
                  ...
                  this.settings.availableNavbarOptions.forEach(function (navbarOpt) {
                    var navbarEl = createOptionElement(
                      navbarOpt.name,
                      navbarOpt.title,
                      'navbarOptionRadios',
                      cl.contains('dark-style')
                  ...
                  navbarTypeOpt
                    .querySelector('input[value="'.concat(this.settings.layoutNavbarOptions, '"]'))
                    .setAttribute('checked', 'checked');
