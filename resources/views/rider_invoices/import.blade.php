...
<form action="{{route('rider.invoice_import')}}" method="POST" enctype="multipart/form-data" id="formajax">
<div class="row">
    <div class="col-12">
      <a href="{{url('sample/rider_invoice_sample.xlsx')}}" class="text-success w-100" download="Rider Invoice Sample">
