      ...
      <li class="timeline-item timeline-item-transparent">
        ...
        <div class="timeline-event">
          <div class="timeline-header mb-3">
            <h6 class="mb-0"><a href="#">{{$row->user->name}}</a> changed status to @isset($row->job_status)<span class="badge bg-label-success">{{App\Helpers\General::JobStatus($row->job_status)}}</span>@endisset</h6>
